...
public final class BOClock {
	...
	public static LocalDateTime getTimeExternalServer(String ip){
		...
		try {
			...
			long timeAmazonServer = getTimeAmazonServer(ip);
			Long utcTimeInMillis = clockSystem.getUTCTimeInMillis();
			DateTime dateUTC = new DateTime(utcTimeInMillis + tempoMensagem + timeAmazonServer);
	...
	public static long getTimeAmazonServer(String ip){
		try {
			DateTime t0 = new DateTime();
